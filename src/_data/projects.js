...
const data = [ 
    ...
    { title : "Github Visuals", link : "https://github-visuals.netlify.app/login", text : "This is the project I built on top of Github API. It Visualizes all the github user’s data into charts, graphs and Diagrams and more."},

    { title : "Comfy Sloth", link : "https://react-course-comfy-sloth-store.netlify.app/", text : "This is an e-commerce web app which has all the functionality of a typical E-commerce store has if not more. "},

    { title : "Bootcamp API", link : "https://github.com/ChandraRoy4214/bootcamp.git", text : "I Developed an efficient and scalable RESTful API for an Offline Boot camp by keeping Model–view–controller architecture in mind." },
